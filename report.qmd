...
This confirmation is in the following [repositories](checkfirst). I am committed to using GitHub version control and Quarto (with R) for reproducible research. 
