...
### Project 1A) Data cleaning and subsetting
  ...
  - I have explored multiple network analysis software, including `tidygraph`, `igraph` and `network` for comparison (@sec-storage). This helps identify the limitations of the current tools and what is needed in the new data object.
...
### Project 1B) Exploratory data analysis
  ...
  - I did the preliminary analysis of the ambulance transfer efficiency (@sec-transferdist). This would help inform the development of the new data object package.
